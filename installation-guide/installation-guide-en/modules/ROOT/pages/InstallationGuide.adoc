...
image::entra_id_app_registration.png[,808,250]
...
* record the generated *client-id* (2) and *client-secret* (3), together with the *tenant-id* as they are required in the _kobee.properties_ file during the subsequent configuration steps.
