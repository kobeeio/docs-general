...
Les exigences techniques détaillées sont disponibles sur xref:5.9@technical-sheet-fr:root:TechSheet.adoc[Fiche Technique Kobee].
...
Pour plus d'informations concernant l'Interface Utilisateur d'Kobee, se référer au xref:5.9@user-guide-fr:root:Introduction.adoc[Guide Utilisateur Kobee].
...
Pour des informations plus détaillées concernant l'Interface de Ligne de Commande Kobee, se référer à la section xref:5.9@user-guide-fr:root:CommandLine.adoc[Interface de Ligne de Commande] dans le __Guide Utilisateur Kobee__.
...
+
Pour plus d'information sur l'installation ou la mise à niveau des Agents avec l'Interface Utilisateur Web, se référer à xref:5.9@how-to-ui-agentinstall-en:root:HowTo_UIAgentInstall.adoc[Interface Utilisateur d'Installation d'un Agent Kobee].
