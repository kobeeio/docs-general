...
All create, update and delete operations of Project and Global Administration objects and components are logged in the Kobee Database.
...
Objects created or modified before the SCM4ALL 4.3 Release will not have an event log in the Kobee database.
====
+
