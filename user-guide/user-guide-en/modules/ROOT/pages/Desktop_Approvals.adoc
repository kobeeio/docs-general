...
It adds an extra condition to the execution of the Level Request: not only must the Requested Date/Time be expired, but the Pre-Approval must also be granted by an IKAN ALM User.
...
* The Rest API documentation linked through the Help menu in IKAN ALM.
