...
It adds an extra condition to the execution of the Level Request: not only must the Requested Date/Time be expired, but the Pre-Approval must also be granted by an Kobee User.
...
Every Approval will result in a notification mail to the Users belonging to the protecting User Group, asking them to grant or reject the Approval via the Outstanding Approvals interface.
...
* <<Desktop_Approvals.adoc#_desktop_approvals_overview,The Approvals Overview>>
* <<Desktop_LevelRequests.adoc#_desktop_lr_actions_approvals,Level Request Details Approval Actions>>
* The Rest API documentation linked through the Help menu in Kobee.
...
+
image::Desktop-OutstandingApprovals-Overview.png[,1268,157] 
+
...
|User Group
|This field contains the name of the Kobee User Group of which a member must grant or reject the approval
...
+
image::Approvals-SearchPanel.png[,1116,325] 
+
