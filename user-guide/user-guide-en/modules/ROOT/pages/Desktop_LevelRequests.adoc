...
If not, you can always visualize the tree by clicking the plus sign in front of the zip file, or use the _Expand All_ / _Collapse All_ links to show or hide the entire tree structure at once.
