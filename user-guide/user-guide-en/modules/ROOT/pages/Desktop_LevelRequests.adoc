...
The _Level Requests Overview_ screen is displayed:
+
image::Desktop-LevelRequests-Overview.png[,1119,708] 
+
...
+
image::Desktop-LevelRequests-Detailed-Summary-Approval.png[,360,308]
+
...
+
image::Desktop-LevelRequests-Detailed-Summary-Deliver.png[,360,308]
+
