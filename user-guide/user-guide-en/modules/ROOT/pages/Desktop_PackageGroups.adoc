...
* <<Desktop_PackageGroups.adoc#_desktop_packagegroupsoverview,The Package Build Groups Overview Screen>>
...
+
image::Desktop-PackageGoups-Create.png[,574,300] 
+
...
+
The _Edit Package Build Group_ screen is displayed.
+
...
+
image::Desktop-PackageGoups-Overview-SearchPanel.png[,947,92] 
+
...
+
image::Desktop-PackageGoups-Edit_Popup.png[,536,237] 
+
...
If you try to add a Package that is part of another Package Build Group, an error is displayed : "A Package can only be part of one Package Build Group. Package '`xyz`' is already part of Package Build Group 'zyx'"
====

. Click the _Add_ button to add the Package.
+
The Package will be added at the end of the list.
You can change the order of the packages by changing the Dependency Level, or by dragging and dropping the Package to the appropriate place.
+
...
Build Results_ is set to __Yes__, all Build Results will be retrieved regardless of their Dependency Level. See: <<Desktop_PackageGroups.adoc#_desktop_createpackagegroup,Creating a Package Build Group>>
====
+
Modify the Dependency Level by selecting the appropriate level from the drop-down list.
+
image::Desktop-PackageGoups-ModifyDependencyLevel.png[,821,335] 
+
...
Example:
+
image::Desktop-PackageGoups-MovePackage.png[,940,340] 
+
[NOTE]
====
...
+
The _View Package_ screen is displayed. See: <<Desktop_Packages.adoc#_desktop_viewpackage,Viewing Package Settings>>.
...
+
image::Desktop-PackageGoups-ConfirmRemoval.png[,412,119] 
+
