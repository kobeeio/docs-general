...
* Active is the default status for package. Active packages may be edited without restrictions, and may be used to start level requests.
* Frozen packages may have their properties edited and may be used to start level requests, but cannot have their file contents edited.
* Archived packages may not be edited and may not be used in Level Requests.
