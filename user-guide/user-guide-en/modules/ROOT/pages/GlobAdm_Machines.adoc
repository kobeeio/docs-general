...
This Protocol defines how sources, scripts, build results and phases will be transported between the IKAN ALM Server locations (Build Archive, Work Copy, Script and Phase Catalog Location) and this Machine.
