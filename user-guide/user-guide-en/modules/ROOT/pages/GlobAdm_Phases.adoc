...
Those Phases are defined in the Kobee database and can be consulted and manipulated in the _Phases_ section of the _Global Administration_ interface.
...
+
image::GlobAdm-Phases-Create.png[,609,577] 
+
...
|The name of the Phase as it will be displayed in the Kobee user interface, e.g., on the _Level Request Detail_ screen or on the _Build Environment
...
|The English name of the Phase as it will be displayed in the Kobee user interface for a User whose language is set to English in his or her __Personal Settings__. See: <<Desktop_PersonalSettings.adoc#_desktop_personalsettings,Personal Settings>>

This field is optional.

|Display Name [French]
|The French name of the Phase as it will be displayed in the Kobee user interface for a User whose language is set to French in his or her __Personal Settings__. See: <<Desktop_PersonalSettings.adoc#_desktop_personalsettings,Personal Settings>>

This field is optional.

|Display Name [German]
|The German name of the Phase as it will be displayed in the Kobee interface for a User whose language is set to German in his or her __Personal Settings__. See: <<Desktop_PersonalSettings.adoc#_desktop_personalsettings,Personal Settings>>
...
* If the Phase needs multiple files for its execution, you must first archive those files into a .zip or a .tar.gz file, and then select that file. Kobee will extract the archive file, and show its contents in the _Uploaded Files_ field.
+
When the upload has succeeded, the following message is displayed:
+
image::GlobAdm-Phases-Create-UploadSuccess.png[,496,43] 
+
...
The following screen is displayed:
+
image::GlobAdm-Phases-Overview.png[,1316,679] 
+
...
A Core Phase is an internal Kobee Phase that performs some core functionality (e.g., the _Retrieve Code_ Phase).
...
To facilitate Phase development, Kobee will automatically re-install a non-released Phase just before it is executed.
...
+
image::GlobAdm-Phases-PhaseParameters.png[,1095,233] 
+
...
+
image::GlobAdm-Phases-ConnectedEnvironments.png[,383,184] 
+
...
+
Meanwhile, Kobee re-packages the uploaded files in a .jar file and replaces the existing .jar file in the Phase Catalog location (as defined in the <<GlobAdm_System.adoc#_globadm_system_settings,System Settings>>) with the new .jar file.
There, it is ready to be picked up by an Kobee Server or Agent Daemon process when the Phase needs to be (re-)installed on an IKAN ALM Server or Agent.
+
You can also click:
...
+
image::GlobAdm-Phases-Release_confirmation.png[,351,102] 
+
...
+
image::GlobAdm-Phases-CreatePhaseParameter.png[,486,318] 
+
. Fill out the fields in the _Create Phase_ panel at the top of the screen. Fields marked with a red asterisk are mandatory:
+
...
|Integration Type
a|This field indicates whether the value of the Parameter is a simple text value, or whether it represents a link (an integration) to an Kobee object type.
...
When you select a type other than __None__, the _Default Value_ field switches to a drop-down list where you can select a specific Kobee object of that type.
...
The following pop-up window will be displayed:
+
image::GlobAdm-PhaseParameter-Edit.png[,494,452] 
+
...
+
image::GlobAdm-PhaseParameter-Edit-ParameterValue.png[,833,670] 
+
...
The following pop-up window will be displayed:
+
image::GlobAdm-PhaseParameter-Delete.png[,374,161] 
+
...
image::GlobAdm-PhaseParameter-Delete-Warning.png[,403,80] 
--
...
====
+
image::GlobAdm-PhaseParameter-MassEdit.png[,669,461] 
+
...
+
image::GlobAdm-Phase-MassReplace_Step1.png[,683,557] 
+
...
+
image::GlobAdm-Phase-MassReplace_Step2.png[,684,557] 
+
...
+
image::GlobAdm-Phase-MassReplace_Step3.png[,686,559] 
+
In this step you have to match the parameters of the original Phase with those of the Replacement Phase.
+
Kobee will try to match parameters with an identical name and type.
...
+
image::GlobAdm-Phase-MassReplace_Step4.png[,683,557] 
+
...
+
image::GlobAdm-Phase-MassDelete_01.png[,683,486] 
+
...
+
image::GlobAdm-Phases-Delete-Confirm.png[,864,418] 
+
. Click _Delete_ to confirm the deletion.
+
...
+
image::GlobAdm-Phases-Delete-StillConnected.png[,564,42] 
+
...
+
Kobee packages the Phase metadata and all the script files in a .jar file.
A file dialog screen will be displayed, asking you where you want to save this .jar file.The exported .jar file can be used to import the Phase again in the future, possibly in another Kobee installation. <<GlobAdm_Phases.adoc#_globadm_phases_importing,Importing a Phase Definition>>
...
+
image::GlobAdm-Phases-Copy.png[,993,876] 
+
...
+
image::GlobAdm-Phases-Import.png[,623,571] 
+
...
+
image::GlobAdm-Phases-Import-Success.png[,995,775] 
+
...
+
When clicking __Import__, the Phase and its Parameters are created in the Kobee database.
