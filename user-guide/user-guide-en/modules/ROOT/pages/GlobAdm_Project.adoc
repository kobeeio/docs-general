...
[NOTE]
====
When editing the Project export file, always change the Project name, since IKAN ALM will refuse to import a Project when another Project with the same name already exists.
====
