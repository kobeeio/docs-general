...
Kobee currently supports different types of Version Control Repositories (VCR):
...
The following sections explain how to define a VCR Repository so that the Kobee Server can connect to it.

[NOTE]
====
You must always install a VCR client on the Kobee Server in order to interact with the VCR Repository.
====
...
|User ID
|Enter the User ID that Kobee will use to access the Subversion Repository.
This field is optional.

|Password
|Enter the Password that Kobee will use to access the Subversion Repository.
This field is optional.

The characters you enter are displayed as asterisks.

|Repeat Password
|Re-enter the Password that Kobee will use to access the Subversion Repository.
...
If Kobee is not able to establish a connection with the Subversion Repository within the defined period, it will consider the Repository to be inaccessible.
...
|===
. Click __Test Connection__ to verify if Kobee can establish a connection to the Subversion Repository. If the test is successful, the following message is displayed:
+
...
[NOTE]
====
Click _Test Connection_ to verify if Kobee can establish a connection to the Subversion Repository. 
...
====
This option is only available if you have Global Administrator Access Rights in Kobee.
Before you can create the Git Version Control Repository in Kobee, you must install a Git Client on the IKAN ALM Server.
====
...
This directory on the Kobee Server is used to clone and cache the Git repository for the IKAN ALM Server and Web Application in order to speed up the Repository processes.
...
_Warning:_ If you provide a user and, optionally, also a password in the dedicated input fields below, do not add them to the Repository (Push) URL, since Kobee will insert those values in the final (Push) URL before executing any Repository command.
...
|User ID
|Enter the User ID that Kobee will use to access the Git Repository.
This field is optional.

Kobee will insert the value of the User ID in the final (Push) URL before executing any Repository command.

|Password
|Enter the Password that Kobee will use to access the Git Repository.
This field is optional.

The characters you enter are displayed as asterisks.
Kobee will insert the value of the Password in the final (Push) URL before executing any Repository commands.
This is only the case for http(s) URLs.
SSH and scp URLs need to function without providing a password.

|Repeat Password
|Re-enter the Password that Kobee will use to access the Git Repository.

|Time-Out (Sec.)
|Enter the Time-Out value in seconds.
If Kobee is not able to establish a connection with the Git Repository within the defined period, it will consider the Repository to be inaccessible.
...
|===
. Click __Test Connection__ to verify if Kobee can establish a connection to the Git Repository. If the test is successful, the following message is displayed:
+
__Info: Could successfully establish a connection
with the Repository.__
+
...
[NOTE]
====
Click _Test Connection_ to verify if Kobee can establish a connection to the Git Repository. 
...
Before you can create the CVS Version Control Repository in Kobee, you must install a CVS Client on the IKAN ALM Server.
====
...
|Command Path
|Enter the path to the Location where the CVS Client command (``cvs.exe`` or ``cvs``) resides on the Kobee Server.
...
|User ID
|Enter the User ID that Kobee will use to access the CVS Repository.

|Password
|Enter the Password that Kobee will use to access the CVS Repository.

The characters you enter are displayed as asterisks.

|Repeat Password
|Re-enter the Password that Kobee will use to access the CVS Repository.
...
|Time-Out (Sec.)
|Enter the Time-Out value in seconds.
If Kobee is not able to establish a connection with the CVS Repository within the defined period, it will consider the Repository to be inaccessible.

The definition of a Time-Out value is mandatory.
|===

. Click __Test Connection__ to verify if Kobee can establish a connection to the CVS Repository. If the test is successful, the following message is displayed:
+
__Info: Could successfully establish a connection
with the Repository.__
+
...
[NOTE]
====
Click _Test Connection_ to verify if Kobee can establish a connection to the CVS Repository. 
...
====
This option is only available if you have Global Administrator Access Rights in Kobee.
Before you can create the TFVC Version Control Repository in Kobee, you must install a TFVC Client   (Team Explorer for MS Visual Studio or Team Explorer Everywhere for Team Foundation Server) on the IKAN ALM Server.
====
. In the Global Administration context, select__ Version Control Repositories > Create__.
...
|User ID
|Enter the User ID that Kobee will use to access the TFVC Repository.

This field is optional.

|Password
|Enter the Password that Kobee will use to access the TFVC Repository.
This field is optional.

The characters you enter are displayed as asterisks.

|Repeat Password
|Re-enter the Password that Kobee will use to access the TFVC Repository.

|Time-Out (Sec.)
|Enter the Time-Out value in seconds.
If Kobee is not able to establish a connection with the TFVC Repository within the defined period, it will consider the Repository to be inaccessible.

The definition of a Time-Out value is mandatory.
|===

. Click __Test Connection__ to verify if Kobee can establish a connection to the TFVC Repository. If the test is successful, the following message is displayed:
+
__Info: Could successfully establish a connection
with the Repository.__
+
...
[NOTE]
====
Click _Test Connection_ to verify if Kobee can establish a connection to the TFVC Repository. 
