...
This Git repository definition will also allow you to connect with a https://www.github.com[GitHub] repository.
====
...
The following screen is displayed:
+
image::GlobAdm-VCR-Create-Git.png[,613,607] 
+
...
|Select the _Yes_ option to clone this Git repository with the _--filter=blob:none_ option active. Enabling this option can greatly speed up the _Retrieve Code_ Phase. Consult the Git clone documentation for more information on this option.
|===
...
+
For a detailed description of the fields, refer to <<GlobAdm_VCR.adoc#_globadm_vcr_git_create,Creating a Git Repository>>.
...
This TFVC repository definition will also allow you to connect with an Azure Devops TFVC repository.
====
. In the Global Administration context, select__ Version Control Repositories > Create__.
