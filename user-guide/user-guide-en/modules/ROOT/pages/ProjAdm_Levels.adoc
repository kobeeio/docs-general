...
This option allows defining Levels and their Environments, which can be assigned to a Kobee Project Lifecycle.
...
When creating a Level (Build, Test or Production), Kobee will automatically link the default flow of core Level Phases to it. 
