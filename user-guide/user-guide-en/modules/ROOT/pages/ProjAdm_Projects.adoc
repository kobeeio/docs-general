...
The _Projects Overview_ screen provides information about the Kobee Projects.
All Kobee Users can display the Projects Overview page.
...
This option is available to all Kobee Users with Project Admin Access Rights.
...
This option is available to Kobee Users with Project Admin Access Rights.
...
[NOTE]
====
This option is only available to Kobee Users with User Access Rights.
====
...
* __Lock / Unlock__. Block or unblock all activity on this Project.
...
If an Issue Tracking System is selected, Kobee will from then on automatically create an Issue Tracking Level Phase when a new Level is created for the Project. <<App_Phases.adoc#_phases_levelphases_issuetracking,Issue Tracking Phase>>

This field is only visible when there are external Issue Tracking Systems defined in Kobee.
