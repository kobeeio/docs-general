...
The Main Menu sections for Level Requests, Packages and Projects remember up to 5 recently visited items. For Level Requests, these items also show the status of the Level Request.

In addition, the Main Menu sections for Level Requests, Builds and Deploys, Packages and Projects also display up to 5 Search Filters.
