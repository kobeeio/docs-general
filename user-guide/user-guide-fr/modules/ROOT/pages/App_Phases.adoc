...
Elles sont définies dans la base de données de Kobee et peuvent être consultées et modifiées dans la section Phases dans le contexte de l'Administration globale.
...
La version des Phases de noyau correspond à la version de Kobee (par exemple, 6.0).
...
Outre ces Phases de noyau, vous pouvez enrichir la fonctionnalité de Kobee en créant vos propres Phases personnalisées qui peuvent être utilisées sur un Niveau.
...
Le journal généré par le script est sauvegardé dans la base de données de Kobee.
...
Outre ces Phases de noyau, vous pouvez enrichir la fonctionnalité de Kobee en créant vos propres Phases personnalisées qui peuvent être utilisées sur un Environnement de construction.
...
Outre ces Phases de noyau, vous pouvez enrichir la fonctionnalité de Kobee en créant vos propres Phases personnalisées qui peuvent être utilisées sur un Environnement de déploiement.
