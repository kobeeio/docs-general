...
Ce paramètre peut être vérifié dans l'Administration Globale de Kobee: Voir Paramètres système, Panneau <<GlobAdm_System.adoc#_ssystemsettings_tablocalenvironment,Environnement local>> :
