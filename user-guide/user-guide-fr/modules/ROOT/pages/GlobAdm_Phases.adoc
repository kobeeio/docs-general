...
Ces Phases sont définies dans la base de données d'Kobee et peuvent être consultées et modifiées dans la section _Phases_ dans le __Menu d'__Administration
globale__.
...
|Le nom de la Phase tel qu'il sera affiché dans l'Interface Utilisateur d'Kobee, par exemple, dans les panneaux _Informations détaillées_ ou __Aperçu des
...
|Le nom anglais de la Phase tel qu'il sera affiché dans l'Interface Utilisateur d'Kobee pour un Utilisateur pour lequel la langue spécifiée dans ses__ Paramètres
...
|Le nom français de la Phase tel qu'il sera affiché dans l'Interface Utilisateur d'Kobee pour un Utilisateur pour lequel la langue spécifiée dans ses__ Paramètres
...
|Le nom allemand de la Phase tel qu'il sera affiché dans l'Interface Utilisateur d'Kobee pour un Utilisateur pour lequel la langue spécifiée dans ses__ Paramètres
...
+
Si vous cliquez sur le bouton __Importer__, la Phase et ses Paramètres sont créés dans la base de données d'Kobee.
