...
+
Le Projet est créé et l'écran _Informations sur le Projet_ s'affichera dans le contexte de la gestion des projets.
...
. Dans le contexte de l'Administration globale, sélectionnez __Projet > Exporter un Projet_.
+
L`'écran suivant s`'affiche:
+
...
. Ensuite, cliquez sur le lien image:icons/Phase_Export.png[,15,15] _Exporter_ en face du Projet requis.
+
...
. Dans le contexte de l'Administration globale, sélectionnez __Projet > Importer un Projet_.
+
L`'écran suivant s`'affiche:
+
