...
. Dans les options du Menu de l'__Administration des Projets__, sélectionnez __Cycles de vie > Créer__.
+
...
. Dans les options du Menu de l'__Administration des Projets__, sélectionnez __Cycles de vie > Aperçu__.
+
