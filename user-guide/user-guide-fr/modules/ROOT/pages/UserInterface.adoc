...
=== Menu Principal
L'Interface Utilisateur d'Kobee est composée de 3 sections principales: le Bureau, la section Administration des projets et la section Administration globale.
...
+
Choisir cette option pour ouvrir l'écran de la Documentation intégrée REST API d'Kobee.
* _À propos de_
+
Choisir cette option pour ouvrir l'écran À propos d'Kobee. Cette page montre les informations au sujet de votre licence installée.
|===
